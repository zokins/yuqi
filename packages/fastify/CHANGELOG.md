...
- fb42b94: Add yuqijs route to fastify config object
...
- a30326c: Remove console log in fasitfy route initialization for `@yuqijs/fastify`
...
- 871466c: Added support for registering yuqijs as a Fastify plugin
